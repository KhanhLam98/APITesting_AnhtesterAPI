...
public class PropertiesHelper {
    ...
    public static String relPropertiesFilePathDefault = "src/test/java/resources/config/configs.properties";
    public static Properties loadAllFiles() {
        LinkedList<String> files = new LinkedList<>();
        //Add tất cả file Properties vào đây theo mẫu
        files.add("src/test/java/resources/config/configs.properties");
